...
\item Let $R, S$ be rings. Call $R, S$ \underline{Morita equivalent}, denoted $R \sim S$, if $R-mod, S-mod$ are naturally equivalent. This is equivalent to saying $Mod-R, mod-S$ are naturally equivalent. 
